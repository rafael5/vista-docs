...
def enrich_file(path: Path) -> bool:
    ...
    try:
        ...
        new_fields = {
            ...
            "word_count": extract_word_count(md),
            "is_stub": extract_is_stub(md),
            "has_toc": extract_has_toc(md),
            ...
            "patch_number": extract_patch_number(md),
            "description": extract_description(md),
            "file_numbers": extract_file_numbers(md),
            "security_keys": extract_security_keys(md),
            "menu_options": extract_menu_options(md),
