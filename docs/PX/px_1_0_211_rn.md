...
patch_gap: null
section: ''
source_file: px_1_0_211_rn.docx
status: draft
title: PCE Standardization 1.0
---

# PCE Standardization 1.0
...
4.1.	New Features Added	1

4.2.	Enhancements and Modifications to Existing	1

4.2.1.	PCE PX*1.0*211	2

4.2.2.	Clinical Reminders PXRM*2.0*42	6

4.2.3.	Health Summary GMTS*2.7*122	11

4.2.4.	Problem List GMPL*2.0*53	13

4.2.5.	Order Entry/Results Reporting OR*3.0*501	14

4.3.	Known Issues	14

5.	Product Documentation	15
...
|-------------------------------------------|---------------------------------------------------|
| Installation Guide                        | px\_1\_0\_211\_dibr.docx  px\_1\_0\_211\_dibr.pdf |
| Release Notes                             | px\_1\_0\_211\_rn.docx  px\_1\_0\_211\_rn.pdf     |
| PCE Technical Manual                      | pxtm.docx  pxtm.pdf                               |
| PCE User Manual                           | pxum.docx  pxum.pdf                               |
| Clinical Reminders Index Technical Manual | pxrm\_index\_tm.docx  pxrm\_index\_tm.pdf         |
| Clinical Reminders Manager’s Manual       | pxrm\_mm.docx  pxrm\_mm.pdf                       |
...
National Acronym Directory: [https://vaww.va.gov/Acronyms/](https://vaww.va.gov/Acronyms/)
