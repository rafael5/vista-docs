...
patch_gap: null
section: ''
source_file: apump422.docx
status: draft
title: =Demographic data in file other than PATIENT file
---
...
|-------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|--------------------|
| August 2014 | LR*5.2*422 – Updates for ICD-10  Overall: Ensured all screen captures followed the SSN guidelines specified in  *Displaying Sensitive Date Guide*  .  Updated Title page  Added Revision History (pp i-ii)  Changed ICD9 to ICD (pp.3, 18, 192, 196)  "FS/Gross/Micro/Dx/ICD Coding [LRAPDGI]" (pp. 84, 360)  "Autopsy protocol &amp; ICD coding [LRAPAUDAA]" and "FS/Gross/Micro/Dx/ICD Coding [LRAPDGI]" (p.20)  "Autopsy protocol &amp; ICD coding [LRAPAUDAA]" (pp.40 49, 343,362)  ICD Coding, Anat Path [LRAPICD] "Select ICD DIAGNOSIS:" and "FS/Gross/Micro/Dx/ICD Coding [LRAPDGI]" (p. 41)  ICD Coding, Anat Path [LRAPICD] "Select ICD DIAGNOSIS:" (pp. 67, 363) | REDACTED          | REDACTED           |
| 01/2001     | Revised                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |                   |                    |
...
Overview of Anatomic Pathology Module	3
...
Special Keys, Commands, and Conventions	7

Manual Conventions	10

Package Management	13

Package Operations	17

Anatomic Pathology Menu	17

Menu Descriptions	18

Anatomic Pathology Menus	20
...
Summary of Selected AP Options	28

SNOMED Coding/Searches	29
...
Anatomic Pathology Menu Options	39

Data Entry, Anat Path [LRAPD]	40

Descriptions	40

Data entry for Autopsies [LRAPAUDA]	40

Coding	41

Data Entry for Autopsies [LRAPAUDA]	42

Provisional Anatomic Diagnoses [LRAPAUPAD]	42

Autopsy Protocol [LRAPAUDAP]	43

Autopsy Protocol and SNOMED Coding [LRAPAUDAB]	44

Autopsy Protocol and ICD Coding [LRAPAUDAA]	49

Final Autopsy Diagnoses Date [LRAPAUFAD]	51

Autopsy Supplementary Report [LRAPAUSR]	52

Autopsy [LRAPAUDAS]	54
...
Example 3:	Editing Data for Cytology	61

(data already entered based on workload profiles)	61

Example 4:	Data Entry for EM	63

Example 5:	Date/Times are not in Sequence	64

Example 6:	More than one Specimen	65

Coding, Anat Path [LRAPCODE]	66

SNOMED Coding, Anat Path [LRAPX]	66

ICD Coding, Anat Path [LRAPICD]	67

Clinical HX/Gross Description [LRAPDGD]	68

Example 1:	Entry of Information for a Surgical Pathology/	69

ASK FROZEN SECTION set to NO	69

Example 2:	Entry of Information for a Surgical Pathology Specimen with a	70

Frozen Section ASK FROZEN SECTION set to YES	70

FS/Gross/Micro/Dx [LRAPDGM]	71

FS/Gross/Micro/DX/SNOMED Coding [LRAPDGS]	73

Example 2:	Entry of Information for a Surgical Pathology Specimen	77

with a Frozen Section	77

Example 3:	Using a Template to enter a Bone Marrow Report	78

Example 4:	Using a Template to Enter a Bethesda system Report for a Cytology	83

FS/Gross/Micro/Dx ICD [LRAPDGI]	84

Enter Old Anat Path Records [LRAPOLD]	86

Supplementary Report, Anat Path [LRAPDSR]	88

Special Studies-EM;Immuno;Consult;pic, Anat Path [LRAPDSS]	91

Edit/Modify Data, Anat Path [LRAPE]	93

Description	93

Edit Log-In &amp; Clinical Hx Anat Path [LRAPED]	94

Modify Anat Path Gross/Micro/Dx/Frozen Sections [LRAPM]	96

Example 1:	Modify Anat Path Gross/Micro/Dx/Frozen Section	96

Example 2:	Surgical Pathology Final Patient Reports Printout	97

Example: 3	Surgical Pathology Final Patient Reports Printout	98

Inquiries, Anat Path [LRAPI]	104

Descriptions	104

Display Surg Path Reports for a Patient [LRAPSPCUM]	105

Display Cytopath Reports for a Patient [LRAPCYCUM]	105

Display EM Reports for a Patient [LRAPEMCUM]	105

Display Stains/Blocks for a Patient [LRAPST]	107

Show List of Accessions for a Patient [LRUPT]	108

Search Options, Anat Path [LRAPSEARCH]	109

Morphology Code Search, SNOMED [LRAPSM]	109

Procedure Code Search, SNOMED [LRAPSP]	111

ICD Code Search [LRAPSI]	112

MULTIAXIAL Code Search, SNOMED [LRAPSEM]	112

Cum Path Data Summaries [LRAPT]	116

Display Final Path Reports by Accession Number [LRAPPA]	120

Log-in Menu, Anat Path [LRAPL]	121

Delete Accession #, Anat Path [LRAPKILL]	129

Print Log Book [LRAPBK]	130

Surgical Pathology Log Book	131

Histopathology Worksheet [LRAPH]	132

Print, Anat Path [LRAPP]	133

Descriptions	133

Print Queue Information	136

Print All Reports on Queue [LRAP PRINT ALL ON QUEUE]	137

Example 1: Surgical Pathology Preliminary Report	137

Example 2: Surgical Pathology Final Patient Reports	140

Example 3: Surgical Pathology Report with Frozen Section	142

Example 4: Change in Prompts if you select the Autopsy Section	144

Delete Report Print Queue [LRAP DELETE]	147

List Pathology Reports in Print Queue [LRAPQ]	147

Print Single Report Only [LRAP PRINT SINGLE] option	149

Add Patient(s) to Report Print Queue [LRAP ADD]	152

Autopsy Data Review [LRAPAURV]	153

Alphabetical Autopsy List [LRAPAUA]	154

Autopsy Status List [LRAPAUSTATUS]	155

Anat Path Accession Reports [LRAPPAR]	156

Anat Path Accession List by Date [LRAPPAD]	156

Anat Path Accession List by Number [LRAPPAN]	158

Sum of Accessions by Date, Anat Path [LRAPA]	160

Entries by Dates, Patient and Accession Number [LRAPPF]	161

List of Path Cases by Resident, Tech, Senior or Clinicians [LRAPAUL]	162

.% Pos, Atyp, Dysp, Neg, Susp, &amp; Unsat : Cytopath [LRAPCYPCT]	163

Accession List with Stains [LRAPSA]	167

Accession Counts by Senior Pathologist [LRAPAULC]	168

Cum Path Data Summaries [LRAPT]	169

Anatomic Pathology Labels [LRAPLBL]	170

Anat Path Slide Labels [LRAPLM]	170

Anat Path Specimen Labels [LRAPLS]	174

Autopsy Slide Labels (Generic) [LRAUMLK]	175

Edit/Print/Display Preselected Lab Tests [LRUMDA]	176

Enter/Edit User Defined Lab Tests Lists [LRUMDE]	176

Edit Print/Display Preselected Lab Tests [LRUMDA]	179

Print Log Book [LRAPBK]	183

Print Final Path Reports by Accession Number [LRAPFICH]	184

SNOMED Field References [LRAPREF]	187

Descriptions	187

Enter/Edit SNOMED File References [LRAPSRE]	188

Medical Journal File Edit [LRAPLIB]	190

Print References for a SNOMED Entry [LRAPSRP]	191

Supervisor, Anat Path [LRAPSUPER]	192

Descriptions	192

Delete Anat Path Descriptions by Date [LRAPDAR]	197

Enter/Edit Lab Description File [LRAPDES]	198

Edit Pathology Parameters [LRAPHDR]	200

[Edit pathology parameters (Example 1 cont’d)]	202

[Edit pathology parameters (Example 2 cont’d)]	204

Enter/Edit Items in a SNOMED Field [LRSNOMEDIT]	207

Incomplete Reports, Anat Path [LRAPINC]	208

Print Path Modifications [LRAPMOD]	209

Example: Print Pathology Report Modifications	209

Anatomic Pathology Topography Counts [LRAPC]	212

Delete Free Text Specimen Entries [LRAPDFS]	213

AP Quality Assurance [LRAPQA]	214

Summary of TC and QA Codes	215

QA Codes Entry/Edit [LRAPQACD]	216

AP Consultation Searches and Reports [LRAPQACN]	219

[Listing of cases sent to SERS Printout]	221

Listing of cases sent to SERS Printout (contd)	222

Cum Path Summaries for Quality Assurance [LRAPQAC]	223

.% Pos, Atyp, Dysp, Neg, Susp, &amp; Unsat Cytopath [LRAPCYPCT]	225

Delete TC and QA Code [LRAPQADEL]	228

Frozen Section, Surgical Path Correlation [LRAPQAFS]	229

Print path gross/micr/dx/fr.sect modifications [LRAPQAM]	232

Example: ‘Surgical Pathology Report’	232

Example: ‘Surgical Pathology’ report continued	233

Malignancy Review [LRAPQAMR]	234

QA Outcome Review Cases [LRAPQOR]	237

10% Random Case Review, Surg Path [LRAPQAR]	242

Edit QA Site Parameters [LRAPQASP]	244

Tissue Committee Review Cases [LRAPQAT]	245

Anatomic Pathology Turnaround Time [LRAPTT]	250

Move Anatomic Path [LRAPMV]	253

AFIP Registries [LRAPAFIP]	254

Prisoner of War Veterans [LRAPDPT]	254

Persian Gulf Veterans [LRAPPG]	255

Edit Referral Patient File [LRUV]	256

Verify/Release Menu, Anat Path [LRAPVR]	257

Descriptions	257

Verify/Release Reports, Anat Path [LRAPR]	258

Example 1: Release of Surgical Report	258

Example 2: Release of an ‘Autopsy’ report	261

Supplementary Report Release, Anat Path [LRAPRS]	262

List of Unverified Pathology Reports [LRAPV]	263

Clinician Options, Anat Path [LRAPMD]	264

Descriptions	264

Display Surg Path Reports for a Patient [LRAPSPCUM]	266

Display Cytopath Reports for a Patient [LRAPCYCUM]	266

Display EM Reports for a Patient [LRAPEMCUM]	266

Edit/Print/Display Preselected Lab Tests [LRUMDA]	268

Print Surgical Pathology Report for a Patient [LRAPSPSGL]	269

Print Cytopathology Report for a Patient [LRAPCYSGL]	269

Print Electron Microscopy Report for a Patient [LRAPEMSGL]	269

Cum Path Data Summaries [LRAPT]	271

Autopsy Protocol/Supplementary Report [LRAPAUPT]	277

Example: Autopsy Protocol Report	278

Workload, Anat Path [LRAPW]	280

Descriptions	280

Cytopathology Screening Workload [LRAPWR]	281

Display Workload for an Accession [LRUWL]	283

EM Scanning and Photo Workload [LRAPWE]	284

Surg Path Gross Assistance Workload [LRAPWRSP]	286

Microfiche of Path Reports	289

To Use at a VAX site	289

To Use at a Non-VAX site	290

Creating a Microfiche Tape	291

Enhancements to Reports on Microfiche	293
...
Anatomic Pathology User Manual Notes for Patch LR*5.2*72	333

Overview of Multidivisional Functionality	334

Anatomic Pathology Data Dictionary and Functionality Changes	335

Anatomic Pathology Option, Functionality, and Other Changes	337

Instructions for Anatomic Pathology for Multidivisional Sites and Multiple AP Accession Areas	338

DATA MERGER Information for the Consolidation Sites	342

LAB DATA file (#63)	342

Post DATA MERGER Instruction for the Consolidation Sites	344

APPENDIX B	347

Anatomic Pathology Patch LR*5.2*248 Changes	347

LAB DATA file (#63) Changes	347

New Fields	347

Anatomic Pathology Option Changes	351

Enhancements	351

Supplementary Report, Anat Path [LRAPDSR] option	351

Autopsy supplementary report [LRAPAUSR] option	353

Modifications	354

Show List of Accessions for a Patient [LRUPT] option	354

Modify anat path gross/micro/dx/frozen section [LRAPM] option	355

Verify/Release Reports, Anat Path [LRAPR] option	355

Example 1: Release of Surgical Report	356

Example 2: Release of ‘Autopsy’ report	357

Enter old anat path records [LRAPOLD] option	358

Log-in, anat path [LRAPLG] option	358

Autopsy protocol/supplementary report [LRAPAUPT] option	358

Clinical Hx/Gross Description/FS [LRAPDGD] option	360

FS/Gross/Micro/Dx [LRAPDGM] option	360

FS/Gross/Micro/Dx/SNOMED Coding [LRAPDGS] option	360

FS/Gross/Micro/Dx/ICD Coding [LRAPDGI] option	360

Supplementary Report, Anat Path [LRAPDSR] option	361

Spec Studies-EM;Immuno;Consult;Pic, Anat Path [LRAPDSS] option	361

Provisional anatomic diagnoses [LRAPAUPAD] option	361

Autopsy protocol [LRAPAUDAP] option	361

Autopsy protocol &amp; SNOMED coding [LRAPAUDAB] option	362

Autopsy protocol &amp; ICD coding [LRAPAUDAA] option	362

Final autopsy diagnoses date [LRAPAUFAD] option	362

Autopsy supplementary report [LRAPAUSR] option	362

Special studies, autopsy [LRAPAUDAS] option	363

SNOMED coding, anat path [LRAPX] option	363

ICD coding, anat path [LRAPICD] option	363

Modify anat path gross/micro/dx/frozen section [LRAPM] option	363

Verify/release reports, anat path [LRAPR] option	364

Supplementary report release, anat path [LRAPRS] option	364

Print path gross/micr/dx/fr.sect modifications [LRAPQAM] option	364

Print path modifications [LRAPMOD] option	364

Example: Print Pathology Report Modifications	365

Print final path reports by accession # [LRAPFICH] option	368

Print all reports on queue [LRAP PRINT ALL ON QUEUE] option	368

Print single report only [LRAP PRINT SINGLE] option	372

Laboratory Option Modifications	372

Accession List by Date [LRUPAD]	372

Lab orders by collection type [LRRP5] option	372
...
path gross assistance workload [LRAPWRSP]
...
a)	Gross description with printout to go to pathologist with the slides

b)	Micro description and Dx to secretary for final typing
...
After a month of entering data for cytologies and/or surgicals is complete (i.e., there are no incompletes), the log for the month can be printed. By printing it at this time, it will contain the diagnoses of each case with the surgeon and pathologist listed, as well as person releasing the report. Until the permanent monthly log is printed, it might be useful to save the daily logs. Cytologies and autopsies are accessioned/logged-in with similar menus under their respective divisions.
...
a)	SNOMED - Systematized Nomenclature of Medicine Vol. I and II

b)	SNOMED - Microglossary for Surgical Pathology
...
2.	Some consideration should be given as to whether the identity of the person to whom the frozen section report was given and the date/time given should be included on the report. This should be included in the text of the report.
...
4.	The following reference provides a good explanation of the usefulness of the autopsy for quality assurance:
...
The information entered through this option is useful for 1) tracking the work performed on each accession via the Display Stains/Blocks for a Patient [LRAPST] option, 2) generating labels via the Anat Path Slide Labels [LRAPLM] option, to be

placed on the glass slides used for microscopic examination, or 3) printing using the Accession List with Stains [LRAPSA] option to serve as a workload recording document.
...
**NOTE:** At the “Enter Etiology, Function, Procedure &amp; Disease ? NO//” prompt,

a Y for “YES” allows you to enter etiology, procedure, or Disease codes.
...
1. If an “^” is entered at any point in the data entry, **except** during a multiple entry, the system will display a message and will delete the accession information.

2. If the system will not accept the patient you are trying to enter, there may be a spelling error or a SSN error on the SF 515 or in the computer, in which case you would correct the error before continuing. Another possibility is that the patient is an outside referral case of a non-VA patient. You must then enter the patient as a referral, as follows:
...
Example 3:	Log-in of Cytopathology Specimen
...
**Example 4:** More than one EM Specimen
...
Accession Counts by Senior Pathologist	Tallies cases by accession area, sorted by the senior pathologist assigned to the case. Contributes to analysis of quality assurance information, since this information relies on the total number of cases, as well as the data for the “outlayers.”
...
, adequately excised.  Reported to LABPROVIDER, THREE at x2420 at    10:55AM.
...
2.	By using the SNOMED &amp; QA Coding field, it is possible to include information at the end of the preliminary reports. In Example #1 below, the field is used to provide a standardized mechanism for the pathologist to enter relevant comments and codes when dictating the microscopic description.

3	By using the Topography Category field, it is possible to standardize a list of topographies used in other options. See Example 2.

4.	By using the Select Slide Label field (under Cytology) it is possible to select what will appear on the label. See Example 2.

5.	By using the Morphology Entry field, it is possible to control the specific codes to be included in the report, % Pos, Atyp, Dysp, Neg, Susp, &amp; Unsat Cytopath specimens [LRAPCYPCT]. See Example 3.

6.	By answering yes to the New Pg for Supplementary Rpt. field, it is possible to cause the Supplementary Report to print on a new page. This field is also available for Autopsy cases. See Example 5.
...
Select AFIP registries Option:   Prisoner of war veterans
...
2. Enter the menu option, Print final path reports by accession #.

Follow the prompts as you would to print any list in the selected Laboratory AP section.

3. At the “Device” prompt, enter: “MICROFICHE/81.”
...
4. When the job is completed, give the tape to a service bureau.
...
The index page is enhanced by suppressing the printing of identical index values, which makes it easier and quicker to read and use.
...
MIRMO	Medical Information Resources Management Office in the Department of Veterans Affairs Central Office in .
...
3. In the Verify/release reports, anat path [LRAPR] option of the Verify/Release Anat Path Menu [LRAPVR] submenu has been **changed** . The date/time of the release has been limited to current time only.
...
4. The FS/Gross/Micro DX/SNOMED coding [LRAPDGS] option of the Data Entry, Anat Path [LRAPD] submenu has been **changed** . The ability to use the LAB DESCRIPTIONS file (#62.5) for rapid entry of standardized text has been expanded to include the LAB DATA file (#63), SURGICAL PATHOLOGY DIAGNOSIS field (#8), SURGICAL PATH DIAGNOSIS subfield (#1.4).

5. For the Autopsy protocol [LRAPAUPT] option in the Clinician option, Anat path [LRAPMD] menu,  a variable was **reset** to eliminate the error which occurred if the option was moved to another menu. (NOIS HOU-0196-715 and LIT-0895-72013)

6. For the Prisoner of War Veterans [LRAPDPT] option in the AFIP Registries....[LRAPAFIP] submenu of the Supervisor, anat path [LRAPSUPER] menu, the problem created by Patch LR*5.2*114 in which additional patients who should not have been included in the report were included is fixed.  (NOIS MAD-0596-41915)
...
ASSOCIATED DIVISION field(#.091), subfield (#.01):   (600)
...
ASSOCIATED DIVISION field (#.091), subfield(#.01):   (663)
...
ASSOCIATED DIVISION field (#.091), subfield (#.01 ):
