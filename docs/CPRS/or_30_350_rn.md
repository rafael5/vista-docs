...
patch_gap: null
section: ''
source_file: or_30_350_rn.docx
status: draft
title: or 30 350 rn.docx
---
...
- TIU\_1\_268.KID which contains the TIU*1*268 patch
- GMPL\_2\_47.KID which contains the GMPL*2*47 patch
- GMPL\_2\_45.KID which contains the GMPL*2*45 patch
- YS\_501\_116.KID which contains the YS*5.01*116 patch
- MHA\_501\_116.ZIP which contains the Mental Health Assistant dll
- PSJ\_5\_307.KID which contains the PSJ*5*307 patch
- GMRV\_5\_28.KID which contains the GMRV*5*28 patch
- VITL5\_P28.ZIP which contains the Vitals dll
- XU8642.KID which contains the XU*8*642 patch
- XU\_8\_0\_P641.ZIP which contains the ePCS GUI tool (the VistA patch XU*8*641 is being released as an informational patch)
- GMRC\_30\_81.KID which contains the GMRC*3*81 patch
- GMTS\_27\_112.KID which contains the GMTS*2.7*112 patch
- OR\_30\_424.KID which contains the OR*3*424 patch
- OR\_30\_350.KID which contains the OR*3*350 patch
- OR\_30\_350.ZIP which contains the CPRS v30.b CPRSChart.exe, Vitals dll, Mental Health dll and the OrderCom dll.
...
- YS*5.01*116 and MHA\_501\_116.ZIP support the conversion of the dll to XE3.

- GMRV*5*28 and VITL5\_P28.ZIP support the conversion of the dll to XE3.

- XU*8*642 adds a timeout for the PKI Verify Service function.

- XU\_8\_0\_P641.ZIP supports the corrections to some issues with the ePCS GUI tool EPCSDATAENTRYFORPRESCRIBER.EXE
...
This parameter is used to specify the name to use for the YS\_MHA\_A DLL.
