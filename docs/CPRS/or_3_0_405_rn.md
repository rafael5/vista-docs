...
patch_gap: null
section: ''
source_file: or_3_0_405_rn.docx
status: draft
title: Computerized Patient Record System GUI v32b
---

# Computerized Patient Record System GUI v32b
...
|---------|-----------------|------------------------------------------------------------------------------------|-----------------------|-----------------------|
| 01/2024 | OR*3.0*615      | Added NSR 20080342 to the New Features list  Added HITPS 393 Patient Safety Issues | CPRS development team | CPRS development team |
...
4.1.	New Features and Functions Added	2

4.1.1.	NSR 20060710 - Real-time notification of potentially missed order checks	2

4.1.2.	NSR 20070506 – Clinic Orders: Outpatient Med Order Dialog, Remove "Clinic" pick-up	2

4.1.3.	NSR 20070920 - Button to Link No Assessment Warning to Allergy Assessment Screens	2

4.1.4.	NSR 20071211 - Change to Allergy/Pharmacy Packages	3

4.1.5.	NSR 20080226 - D/C Order by Adverse Reaction	3

4.1.6.	NSR 20081008 - CPRS Notification Alert Processing Improvement	4

4.1.7.	NSR 20090509 - Park-A-Prescription: Active Prescriptions Awaiting Patient Request to be Dispensed	4

4.1.8.	NSR 20090510 - VistA Evolution PCE: Enhance Identification and Function of National Health Factors, Exams, Treatments, and Education Topics	5

4.1.9.	NSR 20100101 - Indication on all Prescriptions and Medication Orders	6

4.1.10.	NSR 20100825 - Drug-Allergy Order Check Enhancements and Improved Detail	6

4.1.11.	NSR 20101203 - Critical/High Order Check Display	7

4.1.12.	NSR 20111006 - Prevent Confusion Over CPRS Status Display of Orders and Available Actions	7

4.1.13.	NSR 20120101 – Limiting Additional Signers List	8

4.1.14.	NSR 20130903 - VistA Immunization Enhancements	8

4.1.15.	NSR 20141111 - Filter Provider Drop-Down List	9

4.1.16.	NSR 20170302 - Allow Ability to Edit Attributes when Renewing a Medication Order	10

4.1.17.	NSR 20170512 - Change Non-VA Medication Order Dialog to Allow Complex Medication Orders	10

4.1.18.	NSR 20080342 – Allow Ability for User to Clear Their Own Patient Locks	10

4.1.19.	Access to Prescription Drug Monitor Program Functionality	10

4.2.	Patient Safety Issues	11

4.2.1.	HITPS 202 - Critical Order Check Window presenting data poorly	11

4.2.2.	HITPS 419 - Add Titration Functionality to CPRS in Response to (HITPS-0419)	11

4.2.3.	HITPS 776 PSPO 908 - Provider selected wrong medication due to single spacing of the medication list	11

4.2.4.	HITPS 793 PSPO 928 - A patient with active PRN orders for two medications that look and sound alike can possibly receive the wrong medication	11

4.2.5.	HITPS 796 - Surrogates accumulate many notifications	11

4.2.6.	HITPS 972 - Resident interpreted “cancelled” status as a cancelled active medication order	11

4.2.7.	HITPS 985 - Radiology/Imaging test was inadvertently performed on a patient when CPRS Imaging Order should have been discontinued	12

4.2.8.	HITPS 1046 - Outpatient Medications HOLD status confusing to patients and providers	12

4.2.9.	HITPS 1330 - CPRS is displaying an dc order - when you detail display - it shows the original order instead of the actual order that is discontinued	12

4.2.10.	HITPS 1422 - 2 Critical drug order checks but only one comment allowed	12

4.2.11.	HITPS 1538 - Hard stop on order entries for patients without allergy assessment	12

4.2.12.	HITPS 1566 - Free-text results collide when graphing multiple lab tests	12

4.2.13.	HITPS 1603 - 'Split' TIU template field can cause unexpected behavior.	13

4.2.14.	HITPS 1963 - Unauthorized provider who attempted to order Clozapine bypassed alert and assumed the medication had been ordered	13

4.2.15.	HITPS - 2013 Non-VA Meds not released appropriately (see Defect I3413770FY17)	13

4.2.16.	HITPS 2096 - CPRS Alert Review - Physicians May Be Losing Alerts Requiring Action	13

4.2.17.	HITPS 2123 - Providers can back-date the “Effective Date/Time" for a diet order causing a patient to be on a diet they shouldn't be on	13

4.2.18.	HITPS 2470 INC0063186 - **Patient Safety Issue: COMPLETED consult alert in CPRS only displays "Significant Findings: **Yes**", does NOT display actual significant findings!	14

4.2.19.	HITPS 6443 - Action alerts instead of Informational for flag Notifications: Flagged OI Expiring and Flagged OI Order-Output	14

4.2.20.	HITPS - 6472 - Ticket INC3435911 - VBECS update adds or removes modifiers requested by provider during the ordering process of blood products.	14

4.2.21.	HITPS - 8857 Diet Order Patient Safety Issue with order display inconsistency vs order details	14

4.2.22.	HITPS 393 – Locked Patient Records Prevent Pharmacy from Filling Prescriptions	14

4.3.	Defect Tracking System Items	15

4.4.	Known Issues	21

5.	New Parameters	24

5.1.	CPRS Parameters	25

6.	Modified Parameters	25

7.	Product Documentation	26
...
This NSR is not currently available; however, it will be available in the near future. Sites will be

notified when this feature becomes available.
...
This change fixes patient safety item HITPS 1046.
...
This change fixes patient safety item HITPS 776.
...
This change addressed issue HITPS 796.
...
This change fixes patient safety items HITPS 202 and HITPS 1422.
...
This change fixes patient safety items HITPS 972, HITPS 985, HITPS 933, HITPS 1241, and HITPS 1330.
...
Although the original request was to allows a user to clear locks, the final requirements were to enhance the lock message. This NSR enhances the lock message displayed when CPRS is unable to lock a patient record with a lock already in place. The lock message now contains details on the user that locked the patient record and the date/time in which the lock was placed. This change fixes patient safety item HITPS 393.
...
[Back to Top of Patient Safety Issues]

Changes for this patient safety item are included in NSR 20101203.
...
Changes for this patient safety item are included in NSR 20100101.
...
Changes for this patient safety item are included in NSR 20081008.

#### HITPS 972 - Resident interpreted “cancelled” status as a cancelled active medication order

[Back to Top of Patient Safety Issues]

Changes for this patient safety item are included in NSR 20111006.
...
Changes for this patient safety item are included in NSR 20090509.
...
Changes for this patient safety item are included in NSR 20070920.
...
Changes for this patient safety item are included in NSR 20080342.

### Defect Tracking System Items

I16009412FY17 - Old Date Time Wanted included in VistA Blood Establishment Computer Software (VBECS) Order.
...
I6466595FY16 - Selecting encounter in CPRS, edit, and problem selecting diagnosis.
...
I6276207FY16 - Notifications do not clear until someone goes into the system and clears it.
...
I9259852FY16 - TIU Template Field, CPRS GUI adding code that causes problems.
...
I10142391FY16  - OERR Orders Tab: Expiring Med Alert
...
I10133526FY16 - Medication nearing expiration issue.
...
I7546770FY16 CPRS - problem with displaying orders
...
R11575957FY17 TIU TEMPLATE EDITOR ISSUE - END USERS ARE ABLE TO “SORT” THE SHARED TEMPLATES DRAWER
...
R7092191FY16 - Non-VA Meds marked as released when they weren't.
...
I10034909FY16 - undefined error TRAY+6^ORMBLDFH
...
I11551298FY17 -  Transfer to Outpatient for Backdoor Orders Dosage Issue
...
R10248420FY16 - Clozapine Days Supply Issue
...
R18028257FY18 - VBECS orders problem
...
R19047817FY18 - Delayed orders designated as Immediate Collect do not print
...
I19075037FY18 -  VBECS QUICK ORDER INAPPROPRIATE PROMPT FOR T&amp;S
...
R9119851FY16 - SALEM: OERR - Orders Tab: VBECS LC order with NOW time
...
I7304146FY16 -- Expired Type and Screen Orders Issue
...
INC0063186 - A  COMPLETED consult alert in CPRS only displays “Significant Findings: **Yes**”, it does NOT display actual significant findings
...
INC3435911 - New VBECS update adds or removes modifiers requested by provider during the ordering process of blood products.
...
INC3998447 - Component orders attaching themselves to previous Blood Bank specimens in VBECS despite orders NOT being accessioned in VISTA
...
VBECS Issue #740140 Expired VBECS Component orders still active in CPRS
...
INC9855034 CPRS Template Field Error-Template field for Calendar
...
INC11378087 Rejected VBECS Order Displays Incorrect User on Lab Child Order
...
INC11420967 CPRS “Give additional dose now” warning presenting twice
...
INC14093517 Laboratory Quick Order Display Issue
...
INC19422036 Since CPRS 32A was installed, users reported the Lab quick orders requiring specimen input, the specimen pop up box appears 4 times.
...
INC10288037 Default procedure quantity ignored on CPRS encounter form
...
OR NATURE DEFAULT Parameter Default Causing Issues.
...
- **Resolve button for refusal**

**Problem:** When the user enters refusal for a vaccine from a Reminder dialog, enters the appropriate information, saves, and exits the dialog. And then reenters the dialog, the text on the button returns to the original text, not the Refusal/Deferral text.
...
- **VIMM clicking Administered will make Imm Eval Status section behave incorrectly**

**Problem:** Selecting the Administered radio button causes Imm Eval Status section to not respond correctly.

**Workaround:** Either do administered from Imm Eval Status or press the Clear button on the VIMM form.

- **VIMM - Ordering and Encounter Provider Don't Require User to Have Person Class**

**Problem:** When editing a V Immunization record in backdoor PCE, it doesn’t accept the previously entered Ordering or Encounter Provider (it returns “??” when you hit Enter, to accept the previously entered value). This happens, because the user did not have an active person class at the time of the encounter.
...
- **VIMM - Issue Editing Old Immunization for an Inpatient When Lot is Not Active**

**Problem:** When editing an old immunization record for an inpatient in CPRS, and the lot number is not active anymore, the form either doesn’t load, or it loads, but the previously entered lot number doesn’t pre-populate and can’t be selected.
...
- **Editing Group from Reminder Dialog vs Editing Group from Group View**

**Problem:** Editing a Group from a Reminder Dialog, it does not list if the Group is used elsewhere.

**Workaround:** Switch to Group View.

- **Inquiring to a Dialog Group in VistA Does Not Do a Correct Print Out**

**Problem:** Inquiring to a dialog group in VistA does not do a correct print out
...
- **Park (PK) selection during label prompt issue**

**Problem:** When using PP to pull from suspense and at the label prompt, you select PK, nothing happens as PK cannot be selected on Suspended Rx, but there should be a message something to say Park not allowed on a Suspended Rx.
...
- **Issue tracker 512 - Park should not be available at label prompt in option PSO INTERNET REFILLS**

**Problem:** When using option PSO INTERNET REFILLS, if you choose the option Queue at the “Will these refills be Queued or Suspended ? S//” prompt the “Label:” prompt will include the option to park...which should not be allowed in that option.

**Workaround:** Park-a-Prescription should not be enabled until issues identified in testing are corrected and all consuming applications are ready for this functionality.

- **Park Status to work with Essential Medication List for Review**

**Problem:** Originally, refilling a titration order was not allowed. One way to refill using the Automate Internet Refill option was corrected, but there  may be other ways to unpark  that needs to be corrected.

**Workaround:** Park-a-Prescription should not be enabled until issues identified in testing are corrected and all consuming applications are ready for this functionality.

- **Essential Medication List for Review to differentiate ACTIVE from ACTIVE/PARK**

**Problem:** Essential Medication List for Review does not differentiate between ACTIVE and ACTIVE/PARK

**Workaround:** Park-a-Prescription should not be enabled until issues identified in testing are corrected and all consuming applications are ready for this functionality.

**General Usability**

- **Issues with 14-point Font**

**Problem:** Several problems have been reported with using 14-point font in CPRS.

**Workaround:** If this occurs, users can either increase their screen resolution or change to 12-point font.

- **Scaling Issue: Non-VA Meds Order Screen Does Not Display Quit Button**

**Problem:** Some dialogs in CPRS may have display issues when the screen scaling is set to 150% or higher.

**Workaround:** If this issue occurs, change scaling to 100% or 125%.

- **Move Shared Template Buttons:**

**Problem:** In the CPRS GUI Template Editor, certain combinations of computer display settings and CPRS font size may obscure the  Up and Down arrows for moving shared templates up/down in the template hierarchy.
...
- **Critical High Order causing an Access Violation on patients with no allergies**

**Problem:** When an order check came back on a patient and the user tried to select the button to enter an allergy, it caused an access violation.
...
- **In the GUI the Indication text to the right of the cursor disappears during editing**

**Problem:** When the user enters Indication and in order to edit the indication text, she/he
...
- **Indication Report Utility Is Displaying Personal QO when They Should Be Excluded**

**Problem:** The utility is showing personal quick orders when I select the prompt “ALL (excluding personal quick order)”.
