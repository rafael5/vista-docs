...
patch_gap: null
section: ''
source_file: or_3_0_588_rn.docx
status: draft
title: Computerized Patient Record System GUI v32c
---

# Computerized Patient Record System GUI v32c
...
|---------|-----------------|------------------------------------------------------------------------------------------------------|-----------------------|-----------------------|
| 01/2024 | OR*3.0*615      | Added INC25144966, INC25242144, and Unable to Park supply orders to the Defect Tracking System Items | CPRS development team | CPRS development team |
...
4.1.1.	CPRS Write Access Functionality	1

4.1.2.	WebView2Loader.dll	3

4.2.	Patient Safety Issues	3

4.2.1.	HITPS 2000 - Complex Order issue	3

4.2.2.	HITPS 340 - Event delayed transfer of outpatient meds to inpatient meds is not viewable from Orders tab after admission	3

4.2.3.	HITPS 9745 - Patient Record Flags changes to next patient's PRF's although patient selection is cancelled	3

4.2.4.	HITPS 10302 – When renewing multiple orders, and changing the order, it can bring in the incorrect days supply and quantity	4

4.3.	Defect Tracking System Items	4

4.4.	Known Issues	7

5.	New Parameters	7

5.1.	CPRS Parameters	7

5.2.	Modified Parameters	8
...
Changes for this patient safety issue are included in INC00000236287 - Inpatient Medications - Complex Order Issue.

#### HITPS 340 - Event delayed transfer of outpatient meds to inpatient meds is not viewable from Orders tab after admission

Changes for this patient safety issue are included in I9926255FY16 - Meds not viewable in orders tab

#### HITPS 9745 - Patient Record Flags changes to next patient's PRF's although patient selection is cancelled

Changes for this patient safety issue are included in INC26523979 – “RELATED TO THE REPORTED CPRS Pt Record Flag (PRF) Error - Pt Safety Alert N23-01 ISSUE,FURTHER OCCURENCES-HITPS-10039.”
...
I9000178FY16- Service hierarchy problem
...
INC000001236287 - Inpatient Medications - Complex Order Issue
...
INC R10433527FY16 - PATIENT CARE ENCOUNTERS, historical visit prompts for primary provider erroneously.
...
I15588508FY17 - Error entering delayed orders while patient is admitted
...
R18218636FY18 - User states that no one in the Pharmacy can access this one patient file in CPRS, shows locked
...
I9836510FY16 - BL: Text Integration Utility - Other
...
I7509280FY16 - SAM: CPRS - Lab Collect Order entered after cut off time
...
I9926255FY16 - Meds not viewable in orders tab
...
INC19398646 9/3 notes JAWS issue
...
INC21075957 CPRS hover feature is not accessible
...
INC24901775 CPRS V32B :User is not able to print on CPRS
...
INC26701552 Error message when starting new note (duplicates: INC26651638, INC26613580 and INC26629746)
...
INC26523979 - RELATED TO THE REPORTED CPRS Pt Record Flag (PRF) Error - Pt Safety Alert N23-01 ISSUE, FURTHER OCCURENCES - HITPS-10039.
...
INC25144966 – Email links not opening Outlook for some users
...
INC25242144 – Template Editor up and down arrows can be hidden
...
Unable to Park supply orders on the Orders tab.
